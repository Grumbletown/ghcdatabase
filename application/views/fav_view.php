<div class="container">
    <div class="text-right">
        <a href="#" data-toggle="modal" data-target="#TableInfo" class="btn btn-primary btn-xs" id="TableInfoHover"><span class="glyphicon glyphicon-question-sign" ></span></a>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $('#myTable').DataTable({
            ...
            "ajax": {
                url : "<?php echo site_url("favtab/ips_page") ?>",
                type : 'GET'
    ...
    function favreport_js(id, switches, whattab)
    {
        ...
        $.ajax({
            url : "<?php echo site_url('favtab/fav_repo')?>/" + id + "/" + switches + "/" + whattab + "/",
            type: "GET",
            dataType: "JSON",
    ...
    function delete_ip()
    {
        ...
        if(confirm('Are you sure delete this data?'))
        {
            ...
            $.ajax({
                url : "<?php echo site_url('favtab/ajax_delete/')?>",
                type: "POST",
    ...
    function edit_ip(id)
    {
        ...
        //Ajax Load data from ajax
        $.ajax({
            url : "<?php echo site_url('favtab/ip_edit')?>/" + id + "/",
            type: "GET",
            dataType: "JSON",
            success: function(data)
            {
    ...
    function save(weiter)
    {
        ...
        if(save_method == 'add') {
            url = "<?php echo site_url('favtab/ajax_add/')?>";
            msgtext = "hinzugefügt";
        } else {
            url = "<?php echo site_url('favtab/ajax_update')?>";
            msgtext = "geändert!";
        }
...
<div class="page">
    <div class="table-responsive">
        <center><b><caption class="btn btn-danger">Favourite IPs Table</caption></b></center>
